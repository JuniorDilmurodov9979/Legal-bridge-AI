...
import { ScaleIcon, LockClosedIcon, EyeIcon, EyeSlashIcon } from '@heroicons/react/24/outline'
...
export default function ResetPasswordPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!token) {
      toast.error('Token topilmadi. Iltimos, parolni tiklash jarayonini qaytadan boshlang.')
      return
    }
    ...
    try {
      ...
      if (errorData?.error) {
        ...
        toast.error('Xatolik yuz berdi. Token yaroqsiz yoki muddati o\'tgan bo\'lishi mumkin.')
      }
    } finally {
      setIsLoading(false)
    }
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-50 to-blue-100 py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-md w-full">
          <div className="bg-white rounded-xl shadow-lg p-8 text-center">
            ...
            <h3 className="mt-4 text-lg font-medium text-gray-900">Token topilmadi</h3>
            <p className="mt-2 text-sm text-gray-500">
              Parolni tiklash uchun yaroqli token kerak. Iltimos, jarayonni qaytadan boshlang.
            </p>
            <Link to="/forgot-password" className="mt-4 inline-block btn-primary">
              Parolni tiklash
            </Link>
          </div>
        </div>
